...
data class PlayerInit(override val playerName: String, override val scoreInformation: String? = null,
                      override val timeInformation: String? = null
) :Information()



data class PlayerRecord(override val playerName: String, override val scoreInformation: String,
